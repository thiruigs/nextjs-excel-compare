...
export default function Home() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const res = await fetch('/api/compare1', {
        method: 'POST',
        body: formData,
      });
  ...
  return (
    <div>
    <TopBar title="EDGAR and XBRL Team Excel Compare" showBack={true}/>
    <div className="min-h-screen bg-gray-100 flex flex-col items-center justify-center p-4">
      <div className="bg-white shadow-xl rounded-2xl p-8 w-full max-w-md">
        ...
        <form onSubmit={handleSubmit}>
          <div className="mb-4">
            <label className="block font-medium text-gray-700 mb-1">Team File</label>
            <input
              type="file"
              accept=".xlsx,.xls"
          ...
          <div className="mb-4">
            <label className="block font-medium text-gray-700 mb-1">Handdy File</label>
            <input
              type="file"
              accept=".xlsx,.xls"
